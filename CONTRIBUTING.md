...
There is nothing to install or run: this repository has no manifest, no entry point, and no source file in any language. See [About The Project](README.md#about-the-project) for what it actually contains.
